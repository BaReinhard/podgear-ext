    ...
    componentDidMount(){
        if(this.twitch){
            ...
            this.twitch.configuration.onChanged(()=>{
                ...
                this.setState(()=>{
    return                    {accountName:config.accountName, characterName: characterResponse.Name}
                })
            })
            this.twitch.listen('broadcast',(target,contentType,body)=>{
                ...
                this.setState(()=>({accountName: body.accountName,  characterName:characterResponse.Name}))
                // do something...
